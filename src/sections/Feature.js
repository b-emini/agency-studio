                ...
                <div className="feature-widget media">
                  ...
                  <div className="widget-text">
                    ...
                    <p className="gr-text-9 mb-0 pr-11">
                      Each project with have a its own team with a dedicated
                      project manager.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="feature-widget media">
                  ...
                  <div className="widget-text">
                    ...
                    <p className="gr-text-9 mb-0 pr-11">
                      We love discipline & order. We are consistent and very
                      organized.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="feature-widget media">
                  ...
                  <div className="widget-text">
                    ...
                    <p className="gr-text-9 mb-0 pr-11">
                      You have a request? Messages us anytime. We will get back
                      at you in an instant.
                    </p>
                  </div>
                </div>
              </Col>
              ...
              >
                <div className="feature-widget media">
                  ...
                  <div className="widget-text">
                    ...
                    <p className="gr-text-9 mb-0 pr-11">
                      We make sure to deliver the product within the period
                      agreed upon.Punctuality is a quality that we thrive upon.
                    </p>
                  </div>
                </div>
              </Col>
