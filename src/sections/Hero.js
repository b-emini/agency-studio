...
import imgL1Hero from "../assets/image/main/png/l5-hero-img.png";
import imgDot from "../assets/image/main/png/l5-dot-shape.png";
            ...
            >
              <div className="hero-content mt-11 mt-lg-0">
                ...
                <h1 className="title gr-text-2 mb-8">
                  Create & improve your presence with Eminial Studio.
                </h1>
                <p className="gr-text-8 mb-11 pr-md-12">
                  You have a project in mind. All you have to do is contact us.
                  Click below to begin the journey!
                </p>
                <div className="hero-btn">
                  <Button href="/contact2" className="gr-hover-y">
                    GET STARTED
                  </Button>
                </div>
              </div>
